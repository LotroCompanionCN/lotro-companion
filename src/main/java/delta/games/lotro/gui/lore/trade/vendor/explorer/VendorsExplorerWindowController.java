...
public class VendorsExplorerWindowController extends DefaultWindowController
{
  ...
  protected JPanel buildContents()
  {
    ...
    _panelController.getConfiguration().setBorderTitle(Labels.getLabel("lore.trade.vendors.explorer.table.border.title"));
    _panelController.getCountsDisplay().setText(Labels.getLabel("lore.trade.vendors.explorer.count.label"));
