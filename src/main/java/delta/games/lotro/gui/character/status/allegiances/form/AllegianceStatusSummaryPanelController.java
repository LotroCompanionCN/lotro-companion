...
public class AllegianceStatusSummaryPanelController
{
  ...
  private JPanel build()
  {
    ...
    panel.add(GuiFactory.buildLabel(Labels.getLabel("character.status.allegiances.field.level")),c);
    ...
    panel.add(GuiFactory.buildLabel(Labels.getLabel("character.status.allegiances.field.points")),c);
